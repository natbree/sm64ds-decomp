// NONMATCHING: constant / value (div=48). Logic verified correct vs ROM; not
...
int func_ov072_021214dc(void *thiz)
{
    ...
    {
        int b;
        if (_ZN6Player11ShowMessageER9ActorBasejPK7Vector3jj(*(void **)(c + 0x360), c, 0xb2, 0, 0, 0)) {
            func_0201267c(0xf2, c + 0x74);
            c[0x36e]++;
        }
        b = (int)((*(int *)(c + 0xb0) & 0x80000) != 0);
        if (b != 0) {
