...
int _ZN6Lakitu13InitResourcesEv(char *thiz)
{
    ...
    *(int *)(((int)(thiz + 0x3f8)) & 0xFFFFFFFFFFFFFFFFLL) = *(int *)(((int)(thiz + 0x5c)) & 0xFFFFFFFFFFFFFFFFLL);
    *(int *)(((int)(thiz + 0x3fc)) & 0xFFFFFFFFFFFFFFFFLL) = *(int *)(((int)(thiz + 0x60)) & 0xFFFFFFFFFFFFFFFFLL);
    *(int *)(thiz + 0x400) = *(int *)(((int)(thiz + 0x64)) & 0xFFFFFFFFFFFFFFFFLL);
    *(int *)(thiz + 0x410) = 0;
